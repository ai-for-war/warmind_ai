...
Define the multichannel interview assistant workflow that captures a two-speaker
conversation, derives stable utterances, persists stable context, and triggers
