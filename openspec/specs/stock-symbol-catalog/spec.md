...
Define a shared stock symbol catalog that is refreshed from `vnstock` VCI data,
persisted in MongoDB, and exposed through authenticated organization-scoped
read APIs.
