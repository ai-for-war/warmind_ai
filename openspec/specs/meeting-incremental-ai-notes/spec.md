...
Define the incremental AI meeting notes capability that consumes closed
meeting utterances from background processing, stages hot state in Redis,
generates grounded structured note chunks, and emits additive note updates to
the meeting creator.
