"""Service layer for user-managed stock-agent skills."""
...
class StockAgentSkillService:
    """Manage user-scoped stock-agent skill CRUD and enablement."""

    def __init__(
        self,
        skill_repository: StockAgentSkillRepository,
        access_repository: StockAgentSkillAccessRepository,
        tool_catalog_provider: Callable[
            [], Sequence[StockAgentSelectableToolDescriptor]
        ] = get_stock_agent_selectable_tool_catalog,
    ) -> None:
    ...
    async def list_tools(self) -> StockAgentToolListResponse:
        """Return the current user-selectable stock-agent tool catalog."""
        return StockAgentToolListResponse(
            items=[
                StockAgentToolResponse(
    ...
    async def list_skills(
        ...
        *,
        ...
        skill_filter: StockAgentSkillFilterStatus = StockAgentSkillFilterStatus.ALL,
        skip: int = 0,
        limit: int = 20,
    ) -> StockAgentSkillListResponse:
        ...
        if skill_filter == StockAgentSkillFilterStatus.ENABLED:
            if not enabled_skill_ids:
                return StockAgentSkillListResponse(
                    items=[],
                    total=0,
                    skip=skip,
                    limit=limit,
        ...
        elif skill_filter == StockAgentSkillFilterStatus.DISABLED:
    ...
    async def update_skill(
        ...
        *,
        ...
        if not any(
            ...
            raise InvalidStockAgentSkillConfigurationError(
        ...
        if updated_skill is None:
            raise StockAgentSkillNotFoundError()
    ...
    async def enable_skill(
        ...
        *,
        ...
        return StockAgentSkillEnablementResponse(
            skill_id=skill.skill_id,
            is_enabled=True,
        )
    ...
    def _validate_allowed_tool_names(self, tool_names: Sequence[str]) -> list[str]:
        ...
        if invalid_tool_names:
            raise InvalidStockAgentSkillConfigurationError(
                "Unknown or unavailable stock-agent tools: "
    ...
    def _to_skill_response(
        ...
        *,
        ...
        return StockAgentSkillResponse(
            skill_id=skill.skill_id,
            name=skill.name,
