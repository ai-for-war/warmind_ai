...
class StockAgentMessageRepository:
    ...
    def __init__(self, db: AsyncIOMotorDatabase):
        """Initialize StockAgentMessageRepository with database instance.

        Args:
            db: AsyncIOMotorDatabase instance
        """
        self.collection = db.stock_agent_messages
    ...
    async def create(
        ...
        return StockAgentMessage(**message_data)
    ...
    async def get_by_conversation(
        ...
        messages: list[StockAgentMessage] = []
        async for doc in cursor:
            doc["_id"] = str(doc["_id"])
            messages.append(StockAgentMessage(**doc))

        return messages

    async def get_by_id(self, message_id: str) -> Optional[StockAgentMessage]:
    ...
    async def update(
        ...
        return StockAgentMessage(**result)
