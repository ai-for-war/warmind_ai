"""Skill prompt middleware for the stock-agent runtime."""
...
from app.agents.implementations.stock_agent.middleware.shared import (
    as_state_dict,
    get_stock_agent_skill_access_resolver,
    merge_system_prompt,
...
class StockAgentSkillPromptMiddleware(AgentMiddleware[StockAgentState, None, Any]):
    ...
    async def awrap_model_call(
        ...
        resolver = self.skill_access_resolver or get_stock_agent_skill_access_resolver()
