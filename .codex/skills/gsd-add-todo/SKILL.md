...
<execution_context>
@C:/Project/AI_FOR_WAR/ai_service_kiro/.codex/get-shit-done/workflows/add-todo.md
</execution_context>
...
<process>
**Follow the add-todo workflow** from `@C:/Project/AI_FOR_WAR/ai_service_kiro/.codex/get-shit-done/workflows/add-todo.md`.
