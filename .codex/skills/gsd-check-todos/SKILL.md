...
<execution_context>
@C:/Project/AI_FOR_WAR/ai_service_kiro/.codex/get-shit-done/workflows/check-todos.md
</execution_context>
...
<process>
**Follow the check-todos workflow** from `@C:/Project/AI_FOR_WAR/ai_service_kiro/.codex/get-shit-done/workflows/check-todos.md`.
