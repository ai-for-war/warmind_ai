...
Reference full template: `C:/Project/AI_FOR_WAR/ai_service_kiro/.codex/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/Project/AI_FOR_WAR/ai_service_kiro/.codex/get-shit-done/templates/state.md`.
