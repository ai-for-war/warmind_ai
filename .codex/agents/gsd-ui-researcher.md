...
Use template from `C:/Project/AI_FOR_WAR/ai_service_kiro/.codex/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/Project/AI_FOR_WAR/ai_service_kiro/.codex/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "C:/Project/AI_FOR_WAR/ai_service_kiro/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
