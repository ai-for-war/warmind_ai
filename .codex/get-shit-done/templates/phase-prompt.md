...
<!-- For checkpoint task examples and patterns, see @C:/Project/AI_FOR_WAR/ai_service_kiro/.codex/get-shit-done/references/checkpoints.md -->
...
See `C:/Project/AI_FOR_WAR/ai_service_kiro/.codex/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `C:/Project/AI_FOR_WAR/ai_service_kiro/.codex/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `C:/Project/AI_FOR_WAR/ai_service_kiro/.codex/get-shit-done/workflows/verify-phase.md` for verification logic.
