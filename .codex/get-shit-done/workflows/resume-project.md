...
<required_reading>
@C:/Project/AI_FOR_WAR/ai_service_kiro/.codex/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "C:/Project/AI_FOR_WAR/ai_service_kiro/.codex/get-shit-done/bin/gsd-tools.cjs" init resume)
