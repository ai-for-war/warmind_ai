...
- **Global scope**: `C:/Project/AI_FOR_WAR/ai_service_kiro/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Project/AI_FOR_WAR/ai_service_kiro/.codex/notes/`)
...
2. Glob `C:/Project/AI_FOR_WAR/ai_service_kiro/.codex/notes/*.md` (if directory exists) — global notes
...
Global (C:/Project/AI_FOR_WAR/ai_service_kiro/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Project/AI_FOR_WAR/ai_service_kiro/.codex/notes/` — works in any directory
