...
See C:/Project/AI_FOR_WAR/ai_service_kiro/.codex/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using C:/Project/AI_FOR_WAR/ai_service_kiro/.codex/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using C:/Project/AI_FOR_WAR/ai_service_kiro/.codex/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from C:/Project/AI_FOR_WAR/ai_service_kiro/.codex/get-shit-done/templates/discovery.md
...
Use C:/Project/AI_FOR_WAR/ai_service_kiro/.codex/get-shit-done/templates/discovery.md.
