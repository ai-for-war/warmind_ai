...
```bash
PHASE_INFO=$(node "C:/Project/AI_FOR_WAR/ai_service_kiro/.codex/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node "C:/Project/AI_FOR_WAR/ai_service_kiro/.codex/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}")
...
```bash
PHASE_DIR=$(node "C:/Project/AI_FOR_WAR/ai_service_kiro/.codex/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}" --raw)
```
